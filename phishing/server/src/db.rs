...
pub async fn connect(database_url: &str) -> Result<SqlitePool, crate::error::Error> {
...
pub async fn insert(pool: &SqlitePool, credentials: &model::Login) -> Result<(), crate::error::Error> {
    let now = Utc::now();
    sqlx::query(
